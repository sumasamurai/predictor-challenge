...
const Home: NextPage = () => {
  ...
  const [betAmount, setBetAmount] = useState<bigint | number>(0.001);
                    ...
                    <div className="bg-base-100 rounded-3xl shadow-md shadow-secondary border border-base-300 flex flex-col mt-10 relative">
                      ...
                      <div className="p-5 divide-y divide-base-300">
                        <div className=" flex flex-col gap-3 py-5 first:pt-0 last:pb-1">
                          <button onClick={onPlayLong} className="btn btn-secondary btn-sm min-h-[2.5rem]" disabled={isLoading}>
                            Play Long
                          </button>
                        </div>
                        <div className=" flex flex-col gap-3 py-5 first:pt-0 last:pb-1">
                          <button onClick={onPlayShort} className="btn btn-secondary btn-sm min-h-[2.5rem]" disabled={isLoading}>
                            Play Short
                          </button>
                        </div>
